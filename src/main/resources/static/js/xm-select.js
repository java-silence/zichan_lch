        ...
        function z(e, t, n, o, r, i, l, a) {
            ...
            if (null === t.type)
                ...
                (function(e, t, n, o, r) {
                        var i;
                        for (i in n)
                            i in t || P(e, i, null, n[i], o);
                        for (i in t)
                            r && "function" != typeof t[i] || "value" === i || "checked" === i || n[i] === t[i] || P(e, i, t[i], n[i], o)
                    }
                )(e, h, d, r, a),
            ...
            (o = [{
                ...
                value: function(e) {
                    ...
                    return (S = S.map((function(e) {
                        ...
                        }, S), e.paging && P), this.state.loading && _("div", {
                            class: "loading"
                        }, _("span", {
                            class: "loader"
                        })))
            ...
            (o = [{
                ...
                value: function(e, t) {
                    ...
                    return _("xm-select", m, _("input", {
                        ...
                        class: ["xm-body", e.model.type, d ? "" : "dis"].join(" "),
                        ref: function(e) {
                            return n.bodyView = e
                        }
                    }, x), l && _("div", {
        ...
        var De = function() {
            ...
            (n = [{
                ...
                value: function() {
                    ...
                    return this.init(ze[e]),
                        Le[e].init(this.options, !0),
                        this
                }
            }, {
                key: "opened",
                ...
                value: function(e) {
                    var t = this
                        , n = Le[this.options.el].state.sels.map((function(e) {
                ...
                value: function(e, t) {
                    ...
                    if (a(e))
                        return Le[this.options.el].value(this.options.radio ? e.slice(0, 1) : e, t, n),
                            this;
                    l("请传入数组结构...")
                }
            }, {
                ...
                value: function(e) {
                    if (a(e))
                        return Le[this.options.el].append(e),
                            this;
                    l("请传入数组结构...")
                }
            }, {
                ...
                value: function(e) {
                    if (a(e))
                        return Le[this.options.el].del(e),
                            this;
                    l("请传入数组结构...")
                }
            }, {
                ...
                value: function(e) {
                    ...
                    return !0 === t ? Le[this.options.el].base.style.borderColor = n : Le[this.options.el].updateBorderColor(n),
                        this
                }
            }]) && Pe(t.prototype, n),
            o && Pe(t, o),
