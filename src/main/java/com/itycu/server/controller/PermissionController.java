...
public class PermissionController {
	...
	@GetMapping(value = "menubyid",params = "id")
	@ApiOperation(value = "菜单列表,根据父节点ID提取子节点列表，供treegrid使用")
	//@PreAuthorize("hasAuthority('sys:menu:query')")
	public List<Permission> menubyid(Long id) {
		List<Permission> permissionsAll = permissionDao.listAll();
	...
	@ApiOperation(value = "根据id获取某个栏目,生成导航用")
	...
	@ApiOperation(value = "一级菜单")
	@PreAuthorize("hasAuthority('sys:menu:query')")
	public List<Permission> navigationMenu() {
		List<Permission> parents = permissionDao.listNavigation();
