...
public class GenerateInput implements Serializable {
	...
	private List<String> isNullable;
...
//		if (beanFieldComment == null || beanFieldComment.equals("")) {
...
//		}
	...
	public List<String> getIsNullable() {
		return isNullable;
	}

	public void setIsNullable(List<String> isNullable) {
